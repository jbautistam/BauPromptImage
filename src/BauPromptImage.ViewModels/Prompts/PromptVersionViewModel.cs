...
/// </summary>
public class PromptVersionViewModel : Bau.Libraries.BauMvvm.ViewModels.BaseObservableObject
{
	// Variables privadas
	...
	private void InitComboGenerators()
	{
		int index = 0;
			...
			foreach (KeyValuePair<string, AiProvider> keyValue in PromptVersionListViewModel.PromptFileViewModel.MainViewModel.TasksQueueViewModel.ImageGenerationManager.AiProvidersManager.Providers)
